...
$emulsion_customize_args = array(
	...
	"emulsion_bg_image_text"		 => array(
		'section'					 => emulsion_addons_default_values( "emulsion_bg_image_text", 'background_image' ),
		'default'					 => 'current',
		'priority'					 => 10,
		'data_type'					 => $emulsion_setting_type,
		'capability'				 => $emulsion_customize_cap,
		...
		'type'						 => 'radio',
		'choices'					 => array(
			'current'			 => esc_html__( 'Current Setting Color', 'emulsion' ),
			'white'	 => esc_html__( 'White', 'emulsion' ),
		),
	),
	"emulsion_bg_image_blend_color"		 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => '',
		'label'						 => esc_html__( 'Color to blend with image', 'emulsion' ),
		'description'				 => '',
		'active_callback'			 => '',
		'sanitize_callback'			 => 'sanitize_hex_color',
	...
	"emulsion_bg_image_blend_color_amount"	 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => '',
		'label'						 => esc_html__( 'Blend Color Amount', 'emulsion' ),
		'description'				 => '',
		'active_callback'			 => '',
	...
	"emulsion_layout_homepage_post_image"					 => array(
		...
		'transport'					 => 'refresh',
		'unit'						 => '',
		'label'						 => esc_html__( 'Featured Image', 'emulsion' ),
		'description'				 => esc_html__( 'Display control of featured image in the loop', 'emulsion' ),
	...
	"emulsion_block_gallery_section_bg"		 => array(
		'section'					 => 'emulsion_section_block_editor_block_gallery',
		'priority'					 => 10,
		'default'					 => emulsion_addons_default_values( "emulsion_block_gallery_section_bg", emulsion_get_background_color() ),
		'data_type'					 => $emulsion_setting_type,
		'capability'				 => $emulsion_customize_cap,
		'transport'					 => 'postMessage',
		'unit'						 => '',
	...
	"emulsion_block_columns_section_height"	 => array(
		...
		'priority'					 => 10,
		'default'					 => emulsion_addons_default_values( "emulsion_block_columns_section_height", 0 ),
		'data_type'					 => $emulsion_setting_type,
		'capability'				 => $emulsion_customize_cap,
		'transport'					 => 'postMessage',
		'unit'						 => '',
	...
	"emulsion_block_columns_section_bg"		 => array(
		'section'					 => 'emulsion_section_block_editor_block_columns',
		'priority'					 => 10,
		'default'					 => emulsion_addons_default_values( "emulsion_block_columns_section_bg", emulsion_get_background_color() ),
		'data_type'					 => $emulsion_setting_type,
		'capability'				 => $emulsion_customize_cap,
		'transport'					 => 'postMessage',
		'unit'						 => '',
	...
	"emulsion_block_media_text_section_height"	 => array(
		...
		'priority'					 => 10,
		'default'					 => emulsion_addons_default_values( "emulsion_block_media_text_section_height", 0 ),
		'data_type'					 => $emulsion_setting_type,
		'capability'				 => $emulsion_customize_cap,
		'transport'					 => 'postMessage',
		'unit'						 => '',
	...
	"emulsion_block_media_text_section_bg"		 => array(
		'section'					 => 'emulsion_section_block_editor_block_media_text',
		'priority'					 => 10,
		'default'					 => emulsion_addons_default_values( "emulsion_block_media_text_section_bg", emulsion_get_background_color() ),
		'data_type'					 => $emulsion_setting_type,
		'capability'				 => $emulsion_customize_cap,
		'transport'					 => 'postMessage',
		'unit'						 => '',
...
////////////////////////////////////////////	
	...
	"emulsion_google_analytics_tracking_code"				 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => '',
		'label'						 => esc_html__( 'Google Analytics', 'emulsion' ),
		'description'				 => '',
