...
$emulsion_customize_args = array(
	...
	/*"emulsion_block_gallery_section_height"	 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => '',
		'label'						 => esc_html__( 'Block gallery height', 'emulsion-addons' ),
		'description'				 => '',
	...
	"emulsion_block_gallery_section_bg"		 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => '',
		'label'						 => esc_html__( 'Block gallery background', 'emulsion-addons' ),
		'description'				 => '',
		'active_callback'			 => '',
		'sanitize_callback'			 => 'sanitize_hex_color',
	...
	"emulsion_block_columns_section_height"	 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => '',
		'label'						 => esc_html__( 'Block columns height', 'emulsion-addons' ),
		'description'				 => '',
	...
	"emulsion_block_columns_section_bg"		 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => '',
		'label'						 => esc_html__( 'Block columns background', 'emulsion-addons' ),
		'description'				 => '',
		'active_callback'			 => '',
		'sanitize_callback'			 => 'sanitize_hex_color',
	...
	"emulsion_block_media_text_section_height"	 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => 'vh',
		'label'						 => esc_html__( 'Block media text height', 'emulsion-addons' ),
		'description'				 => '',
	...
	"emulsion_block_media_text_section_bg"		 => array(
		...
		'transport'					 => 'postMessage',
		'unit'						 => '',
		'label'						 => esc_html__( 'Block media text background', 'emulsion-addons' ),
		'description'				 => '',
		'active_callback'			 => '',
		'sanitize_callback'			 => 'sanitize_hex_color',
